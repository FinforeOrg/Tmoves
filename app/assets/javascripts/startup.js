$(function()
{
	...
	// Search box:
	$("#search").css("background", "white url(\"/assets/search.png\") 95% center no-repeat").focus(function()
	{
		var self = $(this);
	...
	$("#type-selector a#type-" + type).append("<img src=\"/assets/marker-current-black.png\" />").find("img").css({"position": "absolute", "top": "29px", "left": "12px"});

	$("#type-selector a").click(function()
	{
		$("#type-selector img").remove();

		$(this).append("<img src=\"/assets/marker-current-black.png\" />").find("img").css({"position": "absolute", "top": "29px", "left": "12px"});
